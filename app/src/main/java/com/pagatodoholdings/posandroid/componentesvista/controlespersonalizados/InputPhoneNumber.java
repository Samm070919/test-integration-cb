...
public class InputPhoneNumber extends RelativeLayout implements View.OnClickListener {

    private EditText etContenido;
    boolean tieneAccionIme;
    boolean sePresionoDelete;
    int maximoCaracteres = 10;
    List<TextView> digitos = new ArrayList<>();

    public InputPhoneNumber(final Context context, @Nullable final AttributeSet attrs) {
        super(context, attrs);
        inflate(getContext(), R.layout.input_phone_number_custom, this);
