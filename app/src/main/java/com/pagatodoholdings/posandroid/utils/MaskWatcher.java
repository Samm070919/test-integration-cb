...
public class MaskWatcher implements TextWatcher {
    ...
    public void afterTextChanged(Editable editable) {
        ...
        if (!editable.toString().isEmpty()) {
            if (isScanned) {
                ...
                if (!mask.isEmpty()) {
                    StringBuilder stringBuilder = getNewString(tempEditable);
                    editable.clear();
                    editable.append(stringBuilder);
                }
            } else {
                setEditableNotScanned(editable);
            }
        }
    ...
    private StringBuilder getNewString(String tempEditable) {
    ...
    private void setEditableNotScanned(Editable editable) {
