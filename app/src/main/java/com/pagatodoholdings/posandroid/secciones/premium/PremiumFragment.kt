package com.pagatodoholdings.posandroid.secciones.premium
 ...
 * [PremiumFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [PremiumFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class PremiumFragment : AbstractConfigMenu() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        btn_back_premium.setOnClickListener {
            loadHome()
        }
    }
