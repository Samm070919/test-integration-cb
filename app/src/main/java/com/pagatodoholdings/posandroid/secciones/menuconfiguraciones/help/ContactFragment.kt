 ...
 */
class ContactFragment : AbstractConfigMenu() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        tv_tpv_code.text = "Código TPV: " + MposApplication.getInstance().datosLogin.datosTpv.tpvcod
        tv_contact_number.text = Country.getCountry(MposApplication.getInstance().getDatosLogin().getPais().getCodigo()).contactPhone
        tv_serie.text = "Serie: " + MposApplication.getInstance().datosLogin.cliente.serie
        tv_version.text = "Versión: " + BuildConfig.VERSION_NAME
    }
