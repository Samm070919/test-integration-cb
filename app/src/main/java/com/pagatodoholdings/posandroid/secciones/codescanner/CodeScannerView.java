...
public final class CodeScannerView extends ViewGroup {
    ...
    private String exceptionString = "Frame aspect ratio values should be greater than zero";
     ...
     *
     */
    public OnClickListener setTurnOnFlash(){
        return new FlashClickListener();
    }
